...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex items-center justify-center rounded-xl bg-white/5 p-1 text-muted-foreground', className)}
    {...props}
  />
))
